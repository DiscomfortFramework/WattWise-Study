...
const roomSchema = new mongoose.Schema({
  ...
  entityId: { type: String, required: true } // e.g., "livingroom_sensor"
});

const deviceSchema = new mongoose.Schema({
  name: { type: String, required: true },
  location: { type: String },
  applianceKey: { type: String, required: true },
  // Single entity ID approach - auto-generated from device name
  entityId: { type: String, required: true }, // e.g., "dishwasher_power_consumption"
  powerEntityId: { type: String, required: true },
  // currentEntityId: {type: String},
  switchEntityId: { type: String }, // e.g., "dishwasher_switch_state"
  statusEntityId: { type: String }, // e.g., "dishwasher_status"
  // Metadata
  deviceType: { type: String, default: 'appliance' }, // appliance, sensor, switch
